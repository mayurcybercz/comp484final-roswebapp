...
class RobotState extends Component {
    ...
    getRobotState(){
        ...
        //creates a subscriber to hold variables that are currently store in ros odometry
    ...
    //very difficult math to convert quaternion to euler to finally get the orientation of the robot
